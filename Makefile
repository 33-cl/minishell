...
LIBFT := ./libft
LIBS := ./libft/libft.a
SRC := main.c utils/errors.c utils/free_main.c utils/get_path.c utils/prompt.c utils/reconvert_env.c utils/signals.c utils/signal_handlers.c\
		...
		execution/builtin.c execution/cd.c execution/echo.c execution/environnement.c execution/execute.c execution/execution_utils.c execution/execve.c execution/exit.c execution/export.c execution/pwd.c execution/redirections.c execution/struct_manip.c execution/set_env.c execution/unset.c
...
$(BUILD_DIR)/%.o: %.c minishell.h | $(BUILD_DIR)
	@mkdir -p $(@D)
	$(CC) $(CFLAGS) -c $< -o $@
